...
`),frontmatter:n}}function st(r){let e=$t(r),t=String(e.frontmatter.theme||"light"),o=String(e.frontmatter.colourScheme||"classic");if(!te[t])throw new Error(`Unsupported document theme: ${t}`);if(!V[o])throw new Error(`Unsupported document colour scheme: ${o}`);return{...e,theme:t,colourScheme:o}}function kt(r){let e=st(r),t=e.content.replace(/\r\n/g,`
`).split(`
